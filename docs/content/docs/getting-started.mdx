...
<details>
  ...
  - Tanstack Query with other frameworks: - [Vue Query](https://tanstack.com/query/latest/docs/framework/vue/overview) -
  [Solid Query](https://tanstack.com/query/latest/docs/framework/solid/overview) - [Svelte
  Query](https://tanstack.com/query/latest/docs/framework/svelte/overview) - [SWR](https://swr.vercel.app/) -
  [RTK-Query](https://redux-toolkit.js.org/tutorials/rtk-query) - Maybe
  [react-query-kit](https://github.com/HuolalaTech/react-query-kit)? IDK, haven't looked into it deeply but seems like a
  good fit at first glance. - TRPC with other integrations besides TanStack React Query
  integration](https://trpc.io/docs/client/tanstack-react-query) If any of these would be useful to you, please [let me
  know](/feedback)!
</details>
